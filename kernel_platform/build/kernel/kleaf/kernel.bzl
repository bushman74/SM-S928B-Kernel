...
load("//build/kernel/kleaf/impl:image/super_image.bzl", _super_image = "super_image", _unsparsed_image = "unsparsed_image", _super_image_kunit = "super_image_kunit", _super_image_consolidate = "super_image_consolidate")
...
super_image_kunit = _super_image_kunit
super_image_consolidate = _super_image_consolidate
